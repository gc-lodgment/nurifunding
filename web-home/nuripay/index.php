	...
	<div class="wrap">
		...
		<header class="header pay-header" id="header">
			<div class="container header-box">
                ...
                <div class="linkbar">
                	<ul class="link-nav clr">
                		<li><a href="https://www.nurifunding.co.kr" target="_blank">누리펀딩 안내</a></li>
                		<li class="mg-l">ㅣ</li>
                		<li><a href="https://www.nurifunding.co.kr/invest" target="_blank">펀딩투자</a></li>
                		<li class="mg-l">ㅣ</li>
                		<li><a href="https://www.nurifunding.co.kr/service" target="_blank">회사소개</a></li>
                	</ul>
                </div>
		...
		<div class="contents">
			<section class="pay-sec1">
				<div class="pay-area">
					<h2 class="pay-tit">
						<em>옥션, 쿠팡 등에서 늦은<br class="show-xs"> 판매대금 지급으로 많이 곤란하시죠?</em>
						<p>보유하신 상품 매출을 통해 필요<span class="hidden-xs">하신</span> 자금을 긴급지원<span class="hidden-xs">해 드립니다.</span><span class="hidden-md"> !</span></p>
					</h2>
					<p class="pay-img"><img src="https://nurifunding.co.kr/img/nuripay/miripay/logo_w.png" alt="미리페이 로고"></p>
					<p class="pay-txt-1">또한 동산, 재고자산 등의 매출채권 담보를 활용하여 선지급을 이용하실 수도 있습니다.</p>
					<a href="javascript:;" class="btn-pay btn-move">선지급 신청하기</a>
					<p class="pay-txt-2">※ 미리페이 선지급 서비스는 <span class="hidden-xs">핀테크</span> 전문 P2P금융회사인 누리펀딩이 함께 하는 서비스입니다. <span class="pay-img-2"><a href="https://nurifunding.co.kr" target="_blank"><img src="https://www.nurifunding.co.kr/img/lnb_logo.png" alt="누리펀딩 로고"></a></span></p>
				</div>
			</section>
		...
		<footer class="footer pay-footer" id="footer">
		    <div class="container footer-box ">
		    	<div class="linkbar">
                	...
                	<p class="f-cs-txt hidden-xs"><a href="tel:1666-4570">고객센터 1666-4570</a></p>
                </div>
		        <div class="clr">
		        	<p class="f-cs-txt hidden-md"><a href="tel:1666-4570">고객센터 1666-4570</a></p>
                    <p class="f-pay-txt">
                        궁금하시면 전화주세요! <span>(상담시간 평일 10:00 ~ 18:00)</span>
                    </p>
		        </div>
		        <addresss class="f-pay-txt2 clr">
                   서울시 강남구 테헤란로 82길 15, 11층 (대치동,디아이타워) (주)누리펀딩<br>
                   대표이사 : 김정권 ㅣ 사업자등록번호 677-81-00871 ㅣ help@nurifunding.co.kr<br>
                   ※ 미리페이 서비스는 핀테크 전문 P2P금융회사인 누리펀딩이 함께 하는 서비스입니다.
                   <a href="https://nurifunding.co.kr" target="_blank" class="f-nfLogo"><img src="https://nurifunding.co.kr/img/nuripay/m/f_logo.png" alt="누리펀딩로고"></a>
		        </addresss>
		    </div>
		</footer>
	</div>
