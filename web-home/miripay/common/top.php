...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=0">
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css?ver=<?=time();?>" rel="stylesheet">
  ...
  <script type="text/javascript" src="<?=base_js2;?>/jquery.easing.min.js?ver=<?=time();?>"></script>
   <?php
	switch($page_type) {
		...
		break;
		case "miripay":
			echo "<link rel=\"stylesheet\" href=\"".base_css2."/miripay/miripay.css?ver=".time()."\">";
			echo "<script type=\"text/javascript\" src=\"".base_js2."/miripay/miripay.js?ver=".time()."\"></script>";
		break;
		default:
    ...
    <section class="mlnb-wrap show-xs" id="mlnb-wrap">
      <div class="mlnb-container">
        <header class="mlnb-header">
		  ...
		  <div class="t-box">
			...
			<p class="nth-3">
				...
				<a href="/member/myinvest.php">나의투자</a>
        ...
        <ul class="mlnb">
	      ...
	      <li><a href="/miripay/">미리페이<img src="<?=base_img2;?>/arrow_r_icon.png" alt="바로가기"></a></li>
          <li>
