			...
			<form name="join01" method="post">
				<div class="container">
					...
					<div class="mi-box com-box type-01 row br3">
						...
						<div class="company-join" style="display:none;">
							<p class="mib-p1">
								<span class="label">
							...
							<p class="mib-p3"><a href="#none" onclick="javascript: join_02();" class="btn fc-white bg-blue center-block align-center br4">다음단계</a></p>
						</div>
