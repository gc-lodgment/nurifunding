      ...
      <div class="container">
			...
			<div class="row invest-detail-view-area">
			   <!-- 이미지 -->
				...
				<div class="invest-detail-box bor-ddd br4">
					...
					<?php if($row['state2'] == 'G' || $row['state2'] == 'E') { ?>
        ...
        <div class="row com-box est-wrap">
          <div class="est-box est-com nth-5 br4 col-xs-12">
			<!-- 181008 선전상 상품일 경우 -->
          	<figure class="product-miripay hidden-xs">
          		<img src="https://nurifunding.co.kr/img/invest/product/miripay.jpg" alt="선정산 상품 방식">
          		<figcaption class="hidden">소셜 오픈마켓 매출채권 선정산</figcaption>
          	</figure>
			<!-- // -->
        ...
        <div class="row com-box est-wrap">
          <div class="est-box est-com nth-7 br4 col-xs-12">
			...
			?>
			<h3 class="est-com-h3"><span class="fc-blue">4-1.</span><?=$d_txt?> 시세변동에 따른 리스크 점검</h3>
