...
<section class="miripayBn">
	...
	<figure>
		<a href="/miripay/">
			<img src="http://nurifunding.co.kr/img/banner/bn_miripay.png" alt="미리페이 선지급 서비스" class="hidden-xs">
			<img src="http://nurifunding.co.kr/img/banner/bn_miripay_m.png" alt="미리페이 선지급 서비스" class="hidden-md">
		</a>
	</figure>
</section>
      ...
      <div class="container">
        ...
        <div class="row com-box ip-wrap"id="ip-wrap">
		  ...
		  <?php
			...
			$qry = 'select * from (';
			$qry.= 'select * from (select * from goods where state="Y" and state2 in ("Y", "S") order by edate) as A ';
			$qry.= 'union all ';
			$qry.= 'select * from (select * from goods where state="Y" and state2 in ("G", "E") order by field(state2, "G", "E"), num desc) as B ';
			$qry.= ') as C limit 2';
			$res = mysql_query($qry);
...
<?php
	include_once("/home/ebizdev/web-home/nurifunding.co.kr/www/web-home/ver/common/bottom.php");
?>